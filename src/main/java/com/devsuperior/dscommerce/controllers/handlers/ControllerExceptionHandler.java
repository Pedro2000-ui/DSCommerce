 ...
 * metodo dos Controllers que possam lançar uma determinada exceção.</p>
 *
 ...
 * chamadas até chegar ao Spring, que identifica o metodo anotado com
 * {@link ExceptionHandler} e executa o tratamento correspondente.</p>
 *
 * <p>Com isso, a responsabilidade fica separada:</p>
 * <ul>
 *     <li>O Service identifica a situação e lança a exceção;</li>
 ...
 *
 * <p>O {@link ExceptionHandler} define qual metodo deve ser executado
 * quando uma determinada exceção é lançada. Neste caso, o metodo
...
public class ControllerExceptionHandler {
     ...
     *
     * <p>Quando um recurso solicitado não é encontrado, o metodo cria um
